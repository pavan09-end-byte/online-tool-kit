    ...
    renderMergePDF: (container) => {
      ...
      mergeBtn.onclick = async () => {
        try {
          ...
          setTimeout(PDFTools.hideProgress, 2e3);
        } catch (err) {
    ...
    renderCompressPDF: (container) => {
      container.innerHTML = `
            ...
            <div id="compress-ui" class="tool-process-area" style="display:none">
                <p id="size-info" class="text-sm font-bold text-slate-500"></p>
                <div class="form-group">
                ...
                <button class="btn btn-primary" id="compress-btn">Compress Now</button>
            </div>
            <div class="progress-container">
                <div class="progress-bar"><div class="progress-fill"></div></div>
            </div>
      ...
      container.innerHTML = `
            ...
            <div id="process-area" class="tool-process-area" style="display:none">
                <div class="form-group">
                    ...
                    <small id="page-count-info" class="text-xs text-slate-400 mt-1 block"></small>
                </div>
                <button class="btn btn-primary" id="reorder-btn">Reorder & Download</button>
            </div>
        `;
            ...
            <div id="process-area" class="tool-process-area" style="display:none">
                <div class="form-group">
                    ...
                    <select class="form-control" id="angle">
                        ...
                        <option value="270">90\xB0 Counter-Clockwise</option>
                    </select>
                </div>
