...
window.ImageTools = {
    ...
    renderJPGToPNG: (container) => {
        container.innerHTML = `
            ...
            <div id="preview-area" style="display:none; margin-top:24px; text-align:center">
                <canvas id="preview-canvas" style="max-width:100%; border-radius:8px; border:1px solid #eee"></canvas>
    ...
    renderPNGToJPG: (container) => {
        container.innerHTML = `
            ...
            <div id="process-area" style="display:none; margin-top:24px">
                ...
                <button class="btn btn-primary" id="convert-btn" style="width:100%">Convert to JPG</button>
            </div>
        `;
    ...
    renderResizeImage: (container) => {
        container.innerHTML = `
            ...
            <div id="resize-ui" style="display:none; margin-top:24px">
                <div class="grid-2">
                    <div class="form-group">
    ...
    renderGrayscaleImage: (container) => {
        container.innerHTML = `
            ...
            <div id="process-area" style="display:none; margin-top:24px; text-align:center">
                <canvas id="canvas" style="max-width:100%; margin-bottom:16px"></canvas>
                <button class="btn btn-primary" id="download-btn" style="width:100%">Download Grayscale</button>
            </div>
        `;
        ...
        container.innerHTML = `
            ...
            <div id="process-area" style="display:none; margin-top:24px">
                <div style="position:relative; display:inline-block; max-width:100%">
                    ...
                    <div id="crop-box" style="position:absolute; border:2px dashed #fff; box-shadow:0 0 0 9999px rgba(0,0,0,0.5); cursor:move; width:100px; height:100px; top:0; left:0"></div>
                </div>
    ...
    renderImageToBase64: (container) => {
        container.innerHTML = `
            ...
            <div id="process-area" style="display:none; margin-top:24px">
                <textarea class="form-control" id="output" rows="10" readonly style="font-family:monospace; font-size:12px"></textarea>
                <button class="btn btn-primary" id="copy-btn" style="width:100%; margin-top:16px">Copy Base64</button>
            </div>
        `;
    ...
    renderBase64ToImage: (container) => {
        container.innerHTML = `
            ...
            <button class="btn btn-primary" id="convert-btn" style="width:100%">Convert to Image</button>
            <div id="preview-area" style="display:none; margin-top:24px; text-align:center">
                <img id="preview" style="max-width:100%; border-radius:8px; border:1px solid #eee">
                <button class="btn btn-outline" id="download-btn" style="width:100%; margin-top:16px">Download Image</button>
            </div>
        `;
    ...
    renderSocialResizer: (container) => {
        container.innerHTML = `
            ...
            <div id="process-area" style="display:none; margin-top:24px">
                ...
                <button class="btn btn-primary" id="resize-btn" style="width:100%">Resize & Download</button>
            </div>
        `;
        ...
        container.innerHTML = `
            ...
            <div id="process-area" style="display:none; margin-top:24px">
                ...
                <div class="grid-2">
                    <div class="form-group">
                        <label>Color</label>
                        <input type="color" class="form-control" id="text-color" value="#ffffff">
                    </div>
                    <div class="form-group">
                        <label>Size</label>
                ...
                <button class="btn btn-primary" id="process-btn" style="width:100%">Add Text & Download</button>
            </div>
        `;
